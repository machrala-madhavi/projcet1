...
<tr style="background:rgba(60,60,90,1);color:yellow;table-layout: fixed;">
<c:url value="/resources/images/products/${orderhistory.productid}.jpg" var="eat"></c:url>
<td style="text-align:center;vertical-align: middle;font-weight:bold;color:yellow"><img src="${eat}" height="70" width="100" style="border-radius:15px"/> </td>
<c:url value="/resources/images/suppliers/${orderhistory.supplierid}.jpg" var="rat"></c:url>
<td style="text-align:center;vertical-align: middle;font-weight:bold;color:yellow"> <img src="${rat}" height="70" width="100" style="border-radius:15px"/></td>
...
<td style="text-align:center;vertical-align: middle;font-weight:bold;color:yellow"> ${orderhistory.quantity} </td>
	<c:if test="${orderhistory.reviewgiven==false}">
		...
		Rate product
		<c:url value="reqAddProductRating/${orderhistory.productid}" var="sort"></c:url>
		<form action="${sort}">
